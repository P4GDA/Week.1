...
C1 is initial concentration (M)
V1 is initial volume (mL)
C2 is final concentration (M)
V2 is final volume (mL)
...
Note the volume is in litres (L) in the formula, but the volume you need to use is in mL (150 mL), co you will need to include the conversion in your code (150 / 1000).
...
NaOH has a molecular weight of 39.997 Daltons (g/mol). Calculate the grams of NaOH in the resulting solution (use the number of moles you calculated in the previous question.)
