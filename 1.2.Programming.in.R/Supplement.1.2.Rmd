...
Further information and instructions for using Rstudio in JupyterHub can found in the Week 0 module on Quercus.
...
Throughout these lecture supplements you will find written portions mixed with code chunks. Execute the code chunks as you go through the tutorials to follow along. 
...
Of course, this would be different if we removed all the #:
...
Multiplication takes precedence over addition. Therefore, the calculation below will return the number 14.      4 + 2 * 5 = 4 + 10 = 14
...
Mathematical operators within exponents require brackets. For exmaple, calculate the result of *a* to the power of *b* divided by *c*, where *a* = 100, *b* = 2, *c* = 5. 
